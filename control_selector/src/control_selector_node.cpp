...
/*
 * 1)Доработать проект control_selector, добавив класс движения вдоль стены
 * (правой и левой) в виде наследника абстрактного класса Control
 *  Добавить объекты нового класса в массив controlsj, обеспечив тем самым возможность
